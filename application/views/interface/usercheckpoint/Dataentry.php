      ...
      <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12 form_save_dataPrimary">
            <?= form_open(base_url('usercheckpoint/Dataentry/saveDataPrimary'), 'id=form_save_dataPrimary'); ?>
                           ...
                           <div class="col-md-6">
                                <div class="input-group mb-2">
                                    ...
                                    <select class="form-control" name="resultRDT">
                                        ...
                                        <option value='37'>NEGATIVE</option>
                                        <option value='38'>POSITIVE</option>
                                    </select>
                                </div>
                           </div>
                           <div class="col-md-6">
            ...
            <div class="card card-lightblue">
              ...
              <div class="card-body p-2" style="overflow: auto;margin-right: 20px;white-space:nowrap; margin-right:0px;">
                    ...
                    <div class="card-body p-2">
                      <form id="filterData">
                            <div class="row">
                                  ...
                                  <div class="col-md-5 filterTest hidden2">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table id="tbl_person_covid19" class="table table-bordered table-hover" width="100%">
                      <thead>
                      <tr>
                        <!-- <th width="1"></th> -->
...
$(function(){
    ...
    var tbl_person_covid19, tbl_personCovid19_data;
        tbl_person_covid19 = $("#tbl_person_covid19").DataTable({
                            ...
                            ajax: {
                                url: "<?= base_url('usercheckpoint/Dataentry/getPersonCovid') ?>",
                                type: "POST",
                                data:
                                function(d) {
    ...
    //                         lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
    //                         ajax: {
    //                             url: "<?= base_url('usercheckpoint/Dataentry/getPersonCovidExist') ?>",
    //                             type: "POST",
    //                             data:
    //                             function(d) {
    //                               return tbl_personCovid19_data;
    ...
    // $("#tbl_person_covid19_exist_filter label").css("width","100%").css("padding-right","15px");
    ...
    var save_qstatus = {
        ...
        beforeSubmit: function(e) {
            ...
            $(".submitBtnTestQStatus").attr("disabled", true);
            $(".submitBtnTestQStatus").html("<span class=\"fa fa-spinner fa-pulse\"></span>");
        },
        success: function(data) {
            var d = JSON.parse(data);
            if(d.success == true) {
            ...
            $(".submitBtnTestQStatus").attr("disabled", false);
            $(".submitBtnTestQStatus").html("Save");
            $(".submitBtnTestQStatus").html("<span class=\"fa fa-check\"></span> Save Data");
            $('#tbl_person_covid19').DataTable().ajax.reload();
        }
    };
    ...
    $("#testHistoryDateDuplicate .submitBtnTestHistoryProceed").click(function(){
        $('#form_save_dataTestHistory .proceed').val(1);
        $(".submitBtnTestHistory").attr("disabled", false);
...
function getPrimaryContact(){
    ...
    $.post("<?= base_url() ?>" + "usercheckpoint/Dataentry/getPrimaryContact",{v:a},
        function(data) {
...
// function getMaxCode(){
//     $(".selectPrimary").empty();
//     $.post("<?= base_url() ?>" + "usercheckpoint/Dataentry/getMaxCode",
//       function(data) {
//         $(".personCode").val(data);
//       });
// }
...
function hideall(){
    $(".filterDate,.filterTest,.filterCode,.filterName").hide();
}
...
function covid19_status(){
    ...
    var tbl_person_covid19_status, tbl_personCovid19Status_data;
        tbl_person_covid19_status = $("#tbl_person_covid19_status").DataTable({
                            ...
                            "autoWidth": true,
                            ajax: {
                                url: "<?= base_url('usercheckpoint/Dataentry/getPersonCovidStatus') ?>",
                                type: "POST",
                                data:
                                function(d) {
...
function covid19_test(){
    ...
    var tbl_person_covid19_test, tbl_personCovid19test_data;
        tbl_person_covid19_test = $("#tbl_person_covid19_test").DataTable({
                            ...
                            "autoWidth": true,
                            ajax: {
                                url: "<?= base_url('usercheckpoint/Dataentry/getPersonCovidTest') ?>",
                                type: "POST",
                                data:
                                function(d) {
...
function covid19_qstatus(){
    ...
    var tbl_person_covid19_qstatus, tbl_personCovid19qstatus_data;
        tbl_person_covid19_qstatus = $("#tbl_person_covid19_qstatus").DataTable({
                            ...
                            "autoWidth": true,
                            ajax: {
                                url: "<?= base_url('usercheckpoint/Dataentry/getPersonCovidQStatus') ?>",
                                type: "POST",
                                data:
                                function(d) {
  ...
  function myContact(a){
    ...
    // });
    $.post("<?= base_url() ?>" + "usercheckpoint/Dataentry/getMyContact",{value:a},
        function(a){
          ...
          Highcharts.chart('myContact', {
              chart: {
                  height: len<2?120:len*85,//len<2?100:(len<3?200:(len<6?500:(len<11?650:1000))),
  ...
  function chart5(a){
    $.post("<?= base_url() ?>" + "usercheckpoint/Dataentry/getContact",{value:a},
        function(a){
          var result = JSON.parse(a);
