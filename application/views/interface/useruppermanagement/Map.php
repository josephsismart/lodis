...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-lightblue">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-1" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link clickNav" data-widget="pushmenu" href="#"><i class="fas fa-bars"></i></a>
          </li>
        </ul>
  ...
  <!-- /.content-wrapper -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="../../index3.html" class="brand-link" style="font-size: .8rem">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="font-size: .8rem">
            <div class="image">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <!-- <li class="nav-item">
                <a href="<?= base_url() ?>usermanagement/dashboard" class="nav-link dashboard">
              ...
              <li class="nav-item">
                <a href="<?= base_url() ?>usermanagement/dataentry" class="nav-link dataentry">
              ...
              <li class="nav-item">
                <a href="<?= base_url() ?>usermanagement/map" class="nav-link map">
                  <i class="nav-icon fas fa-map map_entry"></i>
                  <p>
                    Map
                  </p>
                </a>
    ...
    <aside class="control-sidebar control-sidebar" style="height: 1000px;width:18em;">
        <!-- Sidebar -->
        <div class="sidebar">
            <!-- Sidebar Menu -->
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- <li class="nav-item">
                    <div class="card card-dark color-palette-box">
                      <div class="card-header p-1 text-center" style="border-radius:5px;">
                        <b style="white-space: nowrap;font-size:25px;color:#ffc107;text-transform: uppercase;"><?= Date("F d, Y")?></b>
                      </div>
                    </div>
                </li> -->
                            ...
                            <div class="color-palette-set">
                              <div class="bg-orange color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="TPS_MAP" class="custom-control-label text-white ml-2" style="cursor:pointer;"><center class="text-white"><i class="fa fa-virus"></i> <b>CONFIRMED CASES</b></center></label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-danger color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="DED_MAP" class="custom-control-label ml-2" style="cursor:pointer;">DEATHS</label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-success color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="REC_MAP" class="custom-control-label ml-2" style="cursor:pointer;">RECOVERED</label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-primary color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="SUS_MAP" class="custom-control-label ml-2" style="cursor:pointer;">SUSPECTED</label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-purple color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="PRO_MAP" class="custom-control-label ml-2" style="cursor:pointer;">PROBABLE</label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-info color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="PUM_MAP" class="custom-control-label ml-2" style="cursor:pointer;">PUM</label>
                                </div>
                              </div>
                            ...
                            <div class="color-palette-set">
                              <div class="bg-warning color-palette">
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label for="CLEARED_MAP" class="custom-control-label ml-2" style="cursor:pointer;">CLEARED</label>
                                </div>
                              </div>
                ...
                <li class="nav-item" style="width:80%;margin-left:20%;display:none;">
                    <div class="card card-dark color-palette-box">
                      <div class="card-header" style="padding:5px 10px 5px 10px;">
...
<script src="<?= base_url() ?>assets/plugins/jquery/jquery.form.min.js"></script>
<?php $this->load->view('interface/usermanagement/layout/Script')?>
