    ...
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body pb-0" style="overflow: auto;">
        ...
        <div class="col-md-12 p-0">
            <?= form_open(base_url('usermanagement/Dataentry/saveContactTracing'), 'id=form_contact_tracing2'); ?>
            <div class="card card-lightblue">
                  ...
                  <input type="text" class="personContactId" name="personContactId" hidden>
                    ...
                    <div class="table-responsive mailbox-messages" style="overflow: hidden;">
                        <table class="table table-hover table-striped" id="tbl_contact_trace2" width="100%">
                            <thead>
                              <th width="1"><a style="cursor:pointer;" class="btn btn-success btn-xs text-white addEntry2" title="Add" onclick="addEntry2();"><i class="fa fa-plus"></i></a></th>
                              <th style="color:black;">Person</th>
                              <th style="color:black;">Relation</th>
                            </thead>
                          <tbody>
                          </tbody>
                        </table>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info btn-sm submitBtnContactPerson2"><i class="fa fa-check"></i> Save Data</button>
                  <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                </div>
            </div>
            </form>
