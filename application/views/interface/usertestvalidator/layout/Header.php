    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>usertestvalidator/dashboard" class="nav-link dashboard">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>usertestvalidator/dataentry" class="nav-link dataentry">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>usertestvalidator/dataexcel" class="nav-link dataexcel">
              <i class="nav-icon fas fa-file-excel data_excel"></i>
              <p>
                Data Excel Import
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>usertestvalidator/report" class="nav-link report">
