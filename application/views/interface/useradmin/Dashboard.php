          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                ...
                <div id="container1" style="min-width: 100%; height: 300px;margin:-15px;"></div>
              </div>
            </div>
          </div>
      </div>
...
<script type="text/javascript">
      ...
      $("#tbl_covid19_confirmed_barangay tbody").empty();
        var tbl_covid19_confirmed_barangay, tbl_covid19_confirmed_barangay_data;
            tbl_covid19_confirmed_barangay = $("#tbl_covid19_confirmed_barangay").DataTable({
                                ...
                                "autoWidth": true,
                                ajax: {
                                    url: "<?= base_url('useradmin/Dashboard/getCovid19Confirmed') ?>",
                                    type: "POST",
                                    data:
                                    function(d) {
    ...
    $.post("<?= base_url() ?>" + 'useradmin/dashboard/covidGraph',
            //{ value: $("#year1").val() },
            function(data) {
                ...
                Highcharts.chart('container1', {
                    ...
                    title: {
                        text: 'Released Certificates as of Year: '+$("#year1").val()
                    },
                    subtitle: {
                        text: 'Health and Medical Certificates'
                    },
                    xAxis: {
