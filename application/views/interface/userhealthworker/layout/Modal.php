  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body pb-0" style="overflow: auto;">
        <div id="myContact" style="min-width:100%; height: auto;margin:-15px;padding-bottom:20px;"></div>
      </div>
...
<div class="modal fade" id="statusHistory">
  <div class="modal-dialog">
    <?= form_open(base_url('userhealthworker/Dataentry/saveDataStatusHistory'), 'id=form_save_dataStatusHistory'); ?>
...
<div class="modal fade" id="testHistory">
  <div class="modal-dialog">
    <?= form_open(base_url('userhealthworker/Dataentry/saveDataTestHistory'), 'id=form_save_dataTestHistory'); ?>
      <div class="modal-content bg-default">
        <div class="modal-header">
