  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <!-- <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="<?= $system_svg ?>" alt="AdminLTELogo" height="60" width="60">
      </div> -->
      <!-- /.login-logo -->
      <div class="card card-outline card-primary">
        <div class="card-header text-center">
          <a href="../../index2.html" class="h1"><b>School</b>MIS</a>
        </div>
        <div class="card-body">
          ...
          <form action="<?= base_url() ?>requestlogin" method="post">
            <div class="input-group mb-3">
              <input type="text" name="username"
                class="form-control <?php if ($this->input->get("login_attempt") == md5(0)): ?> is-invalid <?php endif ?>" placeholder="Email" autofocus autocomplete="off" required>
            ...
            <div class="input-group mb-3">
              <input type="password" name="password"
                class="form-control <?php if ($this->input->get("login_attempt") == md5(0)): ?> is-invalid <?php endif ?>" placeholder="Password" required>
              <div class="input-group-append">
                <div class="input-group-text">
