...
class Dataexcel extends MY_Controller
{
    ...
    // function index(){
    //     $this->load->view('interface/usertestvalidator/Dataexcel');
    // }
    ...
    public function index()
        {       
            ...
            $page_data += [
                "page_title"        => "Dataexcel",
                "current_location"  => "dataexcel",
                "content"           =>  [$this->load->view('interface/usertestvalidator/Dataexcel', [
